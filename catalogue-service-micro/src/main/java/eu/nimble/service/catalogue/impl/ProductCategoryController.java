...
public class ProductCategoryController {
    ...
    @RequestMapping(value = "/catalogue/category/children-categories",
            produces = {"application/json"},
            method = RequestMethod.GET)
    public ResponseEntity getChildrenCategories(@RequestParam("taxonomyId") String taxonomyId, @RequestParam("categoryId") String categoryId,@RequestHeader(value="Authorization", required=true) String bearerToken) {
        if (!taxonomyIdExists(taxonomyId)) {
            log.error("The given taxonomy id : {} is not valid", taxonomyId);
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(String.format("The given taxonomy id %s is not valid", taxonomyId));
        }
    ...
    @RequestMapping(value = "/catalogue/category/tree",
            produces = {"application/json"},
            method = RequestMethod.GET)
    public ResponseEntity getCategoryTree(@RequestParam("taxonomyId") String taxonomyId, @RequestParam("categoryId") String categoryId,@RequestHeader(value="Authorization", required=true) String bearerToken) {
        if (!taxonomyIdExists(taxonomyId)) {
            log.error("The given taxonomy id : {} is not valid", taxonomyId);
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(String.format("The given taxonomy id %s is not valid", taxonomyId));
        }
